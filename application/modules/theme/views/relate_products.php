...
$parms['whereCondition']    ="category_keywords LIKE '%".$cvso."%'";
$parms['columns']  =   'vendorproductimg_name,category_name,product_name,product_keywords,vendorproduct_acde,vendorproduct_bb_price,vendorproduct_bb_mrp';
$ress =   $this->vendor_model->viewVendorproduct_list($parms);
?>
<section class="trending-product-section">
	<div class="container">
		<div class="section-heading">
			<h4 class="heading-title"><span class="heading-circle"></span> Related Products</h4>
		</div>
