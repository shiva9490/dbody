...
class Ajax_pagination{
    ...
    var $uri_segment		= 3;
    var $full_tag_open		= '<div class="pagination-holder">';
    var $full_tag_close		= '</div>';
    var $first_tag_open		= '<li class="paginate_button page-item ">';
    var $first_tag_close        = '&nbsp;</li>';
    var $last_tag_open		= '&nbsp;<li class="paginate_button page-item ">';
    var $last_tag_close		= '</li>';
    var $first_url		=  ''; // Alternative URL for the First Page.
    var $cur_tag_open		= '&nbsp;<li class="paginate_button page-item  active"><a class="page-link">';
    var $cur_tag_close		= '</a></li>';
    var $next_tag_open		= '&nbsp;<li class="paginate_button page-item ">';
    var $next_tag_close		= '&nbsp;</li>';
    var $prev_tag_open		= '&nbsp;<li class="paginate_button page-item ">';
    var $prev_tag_close		= '</li>';
    var $num_tag_open		= '&nbsp;<li class="paginate_button page-item ">';
    var $num_tag_close		= '</li>';    
    var $new_tag_open		= '<div class="pull-left">';    
    var $new_tag_close		= '</div>';    
    var $page_tag_open		= '<div class="pull-right"><ul class="pagination">';    
    var $page_tag_close		= '</ul></div>';    
    var $target          = '';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = $this->new_tag_open.'Showing ' . ( $curr_offset + 1 ) . ' to ' ;
            ...
            $info .= ' of ' . $this->total_rows .$this->new_tag_close;
            $output .= $info;
        }
        $output .= $this->page_tag_open;
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<a href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.',`'.$this->base_url.'`)">'. $text .'</a>';
    }
}
