...
<section class="contact-section section-ptb">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="contact-form-area">
					<form action="" method="post"  class="track_order contact-form validform">
						...
						<div>
							<button type="submit" name="track" value="Track" class="submit">Track Order</button>
						</div>
					</form>
				</div>
			</div>
    ...
    if($view == ""){
            ?>
    <h4 class="text-center text-info"><i class="fa fa-info-circle"></i> No order id has been available</h4>
            <?php
        }else{
            ?>
    <h4 class="text-center text-success">You order status @ <u><?php  echo $view["order_acde"];?></u> for more details <a href="javascript:void(0)" onclick="loginotp()">Login</a></h4>
            <?php
        }
    ?>
<section id="dashboard-nav" class="dashboard-section">
    <div class="container">
        <ul class="dashbord-nav d-lg-flex flex-wrap align-items-center justify-content-between">
            <li><a class="active" href="#"><i class="fas fa-shipping-fast"></i>Track Orders</a></li>
        </ul>
    </div>
    <div class="container">
