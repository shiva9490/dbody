					         ...
					         <div class="col-md-12 m-3">
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <select class="form-control" name="refer_type" id="exampleFormControlSelect1" required onchange="discType()">
                                            ...
                                            <?php foreach($this->config->item('discountType') as $d){ ?>
                                                <option value="<?php echo $d; ?>" <?php if(set_value('refer_type')==$d){echo 'selected';}?> ><?php echo $d; ?></option>
                                            <?php }	 ?>										
										</select>
                                        <div class="invalid-feedback discc">
                                                        Please provide a valid refer type.
                                        </div>
                                        <span class="text-danger"><?php echo form_error('refer_type'); ?></span>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group b-grey">
                                            <div class="input-group ">
                                                <input type="number" class="form-control arabic_feild"  name="min_refer"   aria-label="notification" aria-describedby="basic-addon3" value="<?php echo set_value('min_refer')?>" required />
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon3"><i class="fa fa-inr" aria-hidden="true"></i></span>
                                                </div>
                                                <span class="text-danger"><?php echo form_error('min_refer'); ?></span>
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <div class="input-group">
                                            <input class="form-control " type="text" name="refer" placeholder="Enter Refer code" value="<?php echo set_value('refer')?>" aria-describedby="basic-addon5"  required readonly>                                            
                                     ...
                                     <div class="col-md-5" id="catt" style="display:none">
                                        <label >Category *</label> <br>
                                           <?php foreach($category as $c){?>
                                                <input type="checkbox" name="cat[]" id="<?php echo $c->category_id;?>" value="<?php echo $c->category_id;?>" onchange="getProducts('/Ajax-Refer-Items')" required>
