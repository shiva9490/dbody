<?php
$ct     =   $this->session->userdata("create-corporate_gifting");
?>
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Corporate Gifting</h4>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                <div class="card">
                    ...
                    <h5 class="m-b-0 text-white">Corporate Gifting List</h5></div>
                    <div class="card-body">
                        <form action="" method="get">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <select class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewCorporate Gifting/');?>')">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="port postList">
                                    <?php $this->load->view("ajax_corporate_gifting");?>      
