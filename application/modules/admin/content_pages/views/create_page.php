                            ...
                            <div class="form-group">   
                                <div class="row">
                                    <div class="col-sm-12 form-group leftcontent">
                                        ...
                                        <textarea name="cpage_leftsidebar" class="texatval form-control" id="cpage_leftsidebar" rows="10" cols="80"></textarea>
                                    </div>
                                    <div class="col-sm-12 form-group contentpage">
                                        <label>Content</label>
                                        <textarea name="cpage_content" class="texatval form-control cpage_content" id="cpage_content" rows="10" cols="80"></textarea>
                                    </div>
                                    <div class="col-sm-12 form-group rightcontent">
                                        <label>Right Content</label>
                                        <textarea name="cpage_rightbar" class="texatval form-control" id="cpage_rightbar" rows="10" cols="80"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
