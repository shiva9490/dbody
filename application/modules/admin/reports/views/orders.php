        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> 
                <div class="card">
                    ...
                    <h5 class="m-b-0 text-white">Orders Report</h5></div>
                    <div class="card-body">
                        <form action="" method="get">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <label>Per Page</label>
                                    <select class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewOrdersReport/');?>')">
                                ...
                                <div class="col-md-2 form-group">
                                    <label>Status </label>
                                    <select class="form-control" id="Statuss" name="status"  onchange="searchFilter('','<?php echo bildourl('viewOrdersReport/');?>')">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <select class="form-control" id="pay_mode" name="pay_mode"  onchange="searchFilter('','<?php echo bildourl('viewOrdersReport/');?>')">
                                        <option value=''>select status</option>
                                    <?php
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-3">
                                            <table>
                                            <tr><td>Total Orders</td><td> : <b><?php echo $total_orders;?></b></td></tr>
                                            <tr><td>Todays Orders</td><td> : <b><?php echo $today_orders;?></b></td></tr>
                                            <tr><td>Total Amount</td><td> : <b><?php echo 'RS. '.number_format($total_amount);?></b></td></tr>
                                            <tr><td>Today Amount</td><td> : <b><?php echo 'RS. '.number_format($today_amount);?></b></td></tr>
                                            </table>
                                       </div>
                                    </div>
                                </div>
