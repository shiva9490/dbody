            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-header bg-success d-flex justify-content-between">
                        <h5 class="m-b-0 text-white">Addon List</h5>
                        <a href="<?php echo base_url('Kart-Admin/Create-Addon');?>" class="btn btn-primary btn-small float-right">Create Addon</a>
                    </div>
                    <div class="card-body">
                        <form method="get">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <select name="limitvalue" class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewAddon/');?>')">
                        ...
                        <div class="row port postList">
                            <?php echo $this->load->view("ajax_addon");?>
                        </div>
                    </div>
                </div>  
            </div>                        
