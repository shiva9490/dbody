            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <h5 class="m-b-0 text-white">Add Occasion</h5>
                    </div>
                    <div class="card-body">
                        <form action="" method="post" class="validform forms-sample" id="sub_category" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Occasion Image <span class="required text-danger">*</span></label>
                                <input type="file" name="image" class="form-control category_upload"  required="" accept=".jpg,.png,.gif,.jpeg"/>
