...
function OpenSignUpForm() {
   //document.getElementById("loginarea").classList.remove('open-form');
   ...
   $('#loginarea').removeClass('open-form');
   $('#signupFormarea').removeClass('open-form');
...
function OpenloginForm() {
    document.getElementById("login-area").classList.remove('open-form');
    document.getElementById("loginarea").classList.add('open-form');
     document.getElementById("signupFormarea").classList.remove('open-form');
}
function clloseFormvalue(){
    document.getElementById("loginarea").classList.remove('open-form');
}
function clloseForm() {
    document.getElementById("signupFormarea").classList.remove('open-form');
...
function signupForm(){
     document.getElementById("signupFormarea").classList.add('open-form');
    document.getElementById("login-area").classList.remove('open-form');
    document.getElementById("loginarea").classList.remove('open-form');
}
