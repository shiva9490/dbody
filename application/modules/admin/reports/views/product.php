        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> 
                <div class="card">
                    ...
                    <h5 class="m-b-0 text-white">product Report</h5></div>
                    <div class="card-body">
                        <form action="" method="get">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <label>Per Page</label>
                                    <select class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewproductReport/');?>')">
                                ...
                                <div class="col-md-2 form-group">
                                    <label>Status </label>
                                    <select class="form-control" id="Statuss" name="status"  onchange="searchFilter('','<?php echo bildourl('viewproductReport/');?>')">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <select class="form-control" id="pay_mode" name="pay_mode"  onchange="searchFilter('','<?php echo bildourl('viewproductReport/');?>')">
                                        <option value=''>select status</option>
                                    <?php
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="port postList">
                                    <?php $this->load->view("ajaxproduct");?>        
                                </div>
                            </div>
                        </div>
                    </div>
