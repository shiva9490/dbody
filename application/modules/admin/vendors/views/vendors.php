        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> 
                <div class="card">
                    ...
                    <h5 class="m-b-0 text-white">Vendors List</h5></div>
                    <div class="card-body">
                        <form action="" method="get">
                            <div class="row form-group">
                                <div class="col-md-2">
                                    <select class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewVendors/');?>')">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="port postList">
                                    <?php $this->load->view("ajax_vendors");?>      
