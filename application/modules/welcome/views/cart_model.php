    ...
    <div class="modal-content">
      ...
      <div class="col-lg-12 col-md-12">
                ...
                <tr class="item first rowid<?php echo $data['rowid'] ?>">
                  <td class="thumb">
                     <img src="<?php echo base_url(); ?>/uploads/products/<?php echo $data['vendorproductimg_name'] ?>" alt="<?php echo $data['id'] ?>">
                  </td>
                  <td class="name"><?php echo $data['product_name'] ?></td>
                  <td class="price">INR <span class="price<?php echo $data['rowid'] ?>"><?php echo $data['vendorproduct_price'] ?></span></td>
                  <td class="qnt-count">
                    <input class="quantity qty<?php echo $data['rowid'] ?> form-control" type="number" min="1" value="<?php echo $data['vendorproduct_quantity'] ?>">
