                            ...
                            <div class="form-group">   
                                <div class="row">
                                    <div class="col-sm-12 form-group leftcontent">
                                        ...
                                        <textarea name="cpage_leftsidebar" id="cpage_leftsidebar" class="texatval" rows="10" cols="80"><?php echo $view->cpage_leftsidebar;?></textarea>
                                    </div>
                                    <div class="col-sm-12 form-group contentpage">
                                        <label>Content</label>
                                        <textarea name="cpage_content" id="cpage_content" class="texatval" rows="10" cols="80"><?php echo $view->cpage_content;?></textarea>
                                    </div>
                                    <div class="col-sm-12 form-group rightcontent">
                                        <label>Right Content</label>
                                        <textarea name="cpage_rightbar" id="cpage_rightbar" class="texatval" rows="10" cols="80"><?php echo $view->cpage_rightbar;?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
