            ...
            <div class="col-lg-12 col-md-12"> 
                <div class="card">
                    <div class="card-header bg-success">
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="m-b-0 text-white"><?php echo $title;?> List</h5>
                            </div>
                            <div class="col-md-6">
                                <a href="<?php echo bildourl('Add-Blog');?>" class="btn btn-primary" style="float: right;">Add</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="get" action="">
                            <div class="row form-group">
                                <div class="col-sm-2">
                                    <select name="limitvalue" class="form-control limitvalue" onchange="searchFilter('','<?php echo bildourl('viewBlog/');?>')">
